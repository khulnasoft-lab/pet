...
## Binary
Go to [the releases page](https://github.com/khulnasoft-lab/pet/releases), find the version you want, and download the zip file. Unpack the zip file, and put the binary to somewhere you want (on UNIX-y systems, /usr/local/bin or the like). Make sure it has execution bits turned on. 

## Mac OS X / Homebrew
You can use homebrew on OS X.
```
$ brew install khulnasoft-lab/pet/pet
```

If you receive an error (`Error: khulnasoft-lab/pet/pet 64 already installed`) during `brew upgrade`, try the following command
...
## RedHat, CentOS
Download rpm package from [the releases page](https://github.com/khulnasoft-lab/pet/releases)
```
$ sudo rpm -ivh https://github.com/khulnasoft-lab/pet/releases/download/v0.3.0/pet_0.3.0_linux_amd64.rpm
```

## Debian, Ubuntu
Download deb package from [the releases page](https://github.com/khulnasoft-lab/pet/releases)
```
$ wget https://github.com/khulnasoft-lab/pet/releases/download/v0.3.6/pet_0.3.6_linux_amd64.deb
...
$ git clone https://github.com/khulnasoft-lab/pet.git
$ cd pet
$ make install
```
...
1. fork a repository: github.com/khulnasoft-lab/pet to github.com/you/repo
2. get original code: `go get github.com/khulnasoft-lab/pet`
